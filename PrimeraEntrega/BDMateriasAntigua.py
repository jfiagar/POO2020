...
def menu_principalBDM():
    ...
    print("[2]  Ingresar Materias Aprobadas")  # Imprime la tercera opción
    print("[3]  mostrar materias cursadas")
    print("[4]  Salir del programa")  # Imprime la cuarta opción
...
def mainBDMAntigua():
    while True:
        ...
        if opcion_elegida == "0":
                    ...
                    with open("BD-Materias-ORDENADA.txt", "w") as file:
                        for indices in val:
                            listaordenada = str(indices) + ";" + listaCM[indices - 1] + ";" + listaNM[
                                indices - 1] + ";" + \
                                            listaCF[indices - 1] + ";" + listaCD[indices - 1] + ";" + listaCC[
            ...
            CD = input("Ingrese el Código del departamento que dicta la Materia: ")  # Código departamento que la dicta
